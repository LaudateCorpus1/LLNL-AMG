...
#ifdef HPE_NBC_COMM
    hypre_ParCSRCommHandle *hypre_ParCSRCommHandleCreateNBC ( HYPRE_Int job , hypre_ParCSRCommPkg *comm_pkg , void *send_data , void *recv_data );
    HYPRE_Int hypre_ParCSRCommHandleDestroyNBC ( hypre_ParCSRCommHandle *comm_handle );
#endif
...
// y = alpha*A*x + beta*y
#ifdef HPE_NBC_COMM
    HYPRE_Int hypre_ParCSRMatrixMatvecOutOfPlaceNBC ( HYPRE_Complex alpha , hypre_ParCSRMatrix *A , hypre_ParVector *x , HYPRE_Complex beta , hypre_ParVector *b, hypre_ParVector *y );
#endif
HYPRE_Int hypre_ParCSRMatrixMatvec ( HYPRE_Complex alpha , hypre_ParCSRMatrix *A , hypre_ParVector *x , HYPRE_Complex beta , hypre_ParVector *y );
HYPRE_Int hypre_ParCSRMatrixMatvecT ( HYPRE_Complex alpha , hypre_ParCSRMatrix *A , hypre_ParVector *x , HYPRE_Complex beta , hypre_ParVector *y );
