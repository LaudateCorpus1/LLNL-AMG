...
typedef MKL_INT           interface_int_t;
typedef sparse_status_t   interface_rtn_status_t;
typedef sparse_matrix_t   interface_spmtx_t;
#endif
#ifdef ARMPL
#include "armpl.h"
typedef armpl_int_t       interface_int_t;
typedef armpl_status_t    interface_rtn_status_t;
typedef armpl_spmat_t     interface_spmtx_t;
/* 
   In <complex.h> I is defined as a macro - undefine for AMG
*/
#undef I
#endif
#endif
...
#ifdef SPMV_OPT
  interface_spmtx_t   *csrHandle;
  interface_spmtx_t   *csrHandleT;
#ifdef MKL
  struct matrix_descr csrMtxDescr;
#endif
#endif
...
#ifdef SPMV_OPT
void generateCSRHandles(MPI_Comm comm, void *solver);
